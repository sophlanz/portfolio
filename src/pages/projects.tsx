        ...
        <div className="projectsContainer" ref={projectsContainerRef}>
          ...
          <div className="projectContainer">
            ...
            <div className="imgContainer">
              <a
                href="https://github.com/sophlanz/translate-deepL"
                target="_blank"
            ...
            <div className="svgs">
              ...
              <a
                href="https://ai-lengua.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
              >
          ...
          <div className="projectContainer">
            ...
            <div className="imgContainer">
              <a
                href="https://github.com/sophlanz/ecommerce-travel"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Image
            ...
            <div className="svgs">
              ...
              <a
                href="https://ecommerce-travel.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Image height={40} width={40} src="/svgs/link.svg" alt="link" />
          ...
          <div className="projectContainer">
            ...
            <div className="imgContainer">
              <a
                href="https://github.com/sophlanz/cv-generator"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Image
            ...
            <div className="svgs">
              ...
              <a
                href="https://cv-curator.up.railway.app/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Image height={40} width={40} src="/svgs/link.svg" alt="link" />
          ...
          <div className="projectContainer">
            ...
            <div className="imgContainer">
              <a
                href="https://github.com/sophlanz/weatherApp"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Image
            ...
            <div className="svgs">
              ...
              <a
                href="https://weather-app-sophlanz.netlify.app/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Image height={40} width={40} src="/svgs/link.svg" alt="link" />
          ...
          <div className="projectContainer">
            ...
            <div className="imgContainer">
              <a
                href="https://github.com/sophlanz/restaurant-page"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Image
            ...
            <div className="svgs">
              ...
              <a
                href="https://sophlanz.github.io/restaurant-page/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Image height={40} width={40} src="/svgs/link.svg" alt="link" />
          ...
          <div className="projectContainer">
            ...
            <div className="imgContainer">
              <a
                href="https://github.com/sophlanz/etch-a-sketch"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Image
            ...
            <div className="svgs">
              ...
              <a
                href="https://sophlanz.github.io/etch-a-sketch/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Image height={40} width={40} src="/svgs/link.svg" alt="link" />
