    ...
    return (
        ...
        <div className="aboutContainer">
            <section className="aboutMe">
                <h1>Sophia</h1>
                <p>
                 From<span style={{fontStyle:'italic'}}> English Teacher </span> to <span style={{fontStyle:'italic'}}> <span style={{color:'#2217f1',fontFamily:"Telegraf-UltraBold"}}> React/Next.JS </span> developer, </span> I&apos;m 
